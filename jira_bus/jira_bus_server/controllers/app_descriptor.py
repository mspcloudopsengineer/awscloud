...
from jira_bus.jira_bus_server.constants import backend_urls, frontend_urls, APP_KEY
    ...
    def app_descriptor(self, base_host=None):
        return {
            ...
            "modules": {
                ...
                "jiraIssueContents": [
                    {
                        ...
                        "content": {
                            "type": "label",
                            "label": {"value": self.APP_SHORT_NAME},
                        },
                        "tooltip": {"value": self.APP_SHORT_NAME},
                        "name": {
                            "value": self.ISSUE_PANEL_NAME,
                        },
                        "target": {
                ...
                "webhooks": [
                    {"event": "jira:issue_updated", "url": backend_urls.issue_updated},
                    {"event": "jira:issue_deleted", "url": backend_urls.issue_deleted},
                ],
            },
