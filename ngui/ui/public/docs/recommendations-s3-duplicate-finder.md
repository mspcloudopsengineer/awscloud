...
- Status: See the current status of a specific check in the "Progress" column. The time label indicates the moment when a check was initiated. The successfully finished check has the status â€˜Completedâ€?
...
Want to learn more? Check out this post - [How to find duplicate objects in AWS S3](https://docs.cloudhub.com/how-to-find-duplicate-objects-in-aws-s3/)